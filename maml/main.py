...
flags.DEFINE_string('datasource', 'omniglot', 'omniglot')
...
flags.DEFINE_integer('num_filters', 64, 'number of filters for conv nets --  64 for omiglot.')
